...
const premiumPreviewPanels = [
  {
    ...
    accentClassName: "bg-emerald-500/14 text-emerald-300",
    Icon: Brain,
    renderMobileContent: (isDark) => (
      <div>
        <div className="grid grid-cols-2 gap-4">
          <div className={`rounded-[1.15rem] p-3 ${isDark ? "bg-white/[0.04]" : "bg-white/92 shadow-[0_10px_30px_-24px_rgba(15,23,42,0.18)]"}`}>
          ...
          <div className={`rounded-[1.15rem] p-3 ${isDark ? "bg-white/[0.04]" : "bg-white/92 shadow-[0_10px_30px_-24px_rgba(15,23,42,0.18)]"}`}>
            <p className={`text-[10px] font-semibold uppercase tracking-[0.18em] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Concepts</p>
    ...
    renderContent: (isDark) => (
      <div className="space-y-4">
        <div className="grid gap-3 sm:grid-cols-2">
          <div className={`rounded-[1.4rem] border p-4 backdrop-blur-sm ${isDark ? "border-white/10 bg-white/5" : "border-slate-200 bg-white/88 shadow-[0_20px_40px_-32px_rgba(15,23,42,0.25)]"}`}>
            <p className={`text-[11px] font-semibold uppercase tracking-[0.22em] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Question Bank</p>
          ...
          <div className={`rounded-[1.4rem] border p-4 backdrop-blur-sm ${isDark ? "border-white/10 bg-white/5" : "border-slate-200 bg-white/88 shadow-[0_20px_40px_-32px_rgba(15,23,42,0.25)]"}`}>
            <p className={`text-[11px] font-semibold uppercase tracking-[0.22em] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Concepts</p>
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className={`rounded-[1.2rem] border px-4 py-3 text-sm font-medium ${isDark ? "border-[#2D6BFF]/30 bg-[#2D6BFF]/14 text-[#8EB0FF]" : "border-[#2D6BFF]/18 bg-[#2D6BFF]/8 text-[#1E5EFF]"}`}>Practice</div>
          <div className={`rounded-[1.2rem] border px-4 py-3 text-sm font-medium ${isDark ? "border-emerald-400/20 bg-emerald-500/10 text-emerald-300" : "border-emerald-300/40 bg-emerald-50 text-emerald-700"}`}>Flashcards</div>
          <div className={`rounded-[1.2rem] border px-4 py-3 text-sm font-medium ${isDark ? "border-amber-400/20 bg-amber-500/10 text-amber-300" : "border-amber-300/40 bg-amber-50 text-amber-700"}`}>Mock Exams</div>
        </div>
      </div>
    ),
  },
  {
    ...
    accentClassName: "bg-[#2D6BFF]/14 text-[#8EB0FF]",
    Icon: ClipboardCheck,
    renderMobileContent: (isDark) => (
      <div>
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className={`text-[10px] font-semibold uppercase tracking-[0.18em] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Mock readiness</p>
          ...
          <span className={`rounded-full px-3 py-1 text-[10px] font-semibold ${isDark ? "bg-amber-500/16 text-amber-300" : "bg-amber-100 text-amber-700"}`}>Keep practicing</span>
        </div>
    ...
    renderContent: (isDark) => (
      <div className="space-y-4">
        <div className={`rounded-[1.4rem] border p-5 backdrop-blur-sm ${isDark ? "border-white/10 bg-white/5" : "border-slate-200 bg-white/88 shadow-[0_20px_40px_-32px_rgba(15,23,42,0.25)]"}`}>
          <div className="flex items-center justify-between text-sm">
            <span className={`font-semibold ${isDark ? "text-white" : "text-slate-900"}`}>Average mock score</span>
            <span className={`rounded-full px-3 py-1 font-semibold ${isDark ? "bg-amber-500/16 text-amber-300" : "bg-amber-100 text-amber-700"}`}>Keep practicing</span>
          </div>
          <div className="mt-5">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className={`rounded-[1.2rem] border px-4 py-3 ${isDark ? "border-emerald-400/18 bg-emerald-500/8" : "border-emerald-300/40 bg-emerald-50"}`}>
            <p className={`text-[11px] font-semibold uppercase tracking-[0.2em] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Passed</p>
          ...
          <div className={`rounded-[1.2rem] border px-4 py-3 ${isDark ? "border-amber-400/18 bg-amber-500/8" : "border-amber-300/40 bg-amber-50"}`}>
            <p className={`text-[11px] font-semibold uppercase tracking-[0.2em] ${isDark ? "text-slate-400" : "text-slate-500"}`}>Need review</p>
  ...
  },
  {
    ...
    accentClassName: "bg-violet-500/14 text-violet-300",
    ...
    renderContent: (isDark) => (
      <div className="space-y-4">
        <div className={`space-y-3 rounded-[1.4rem] border p-5 backdrop-blur-sm ${isDark ? "border-white/10 bg-white/5" : "border-slate-200 bg-white/88 shadow-[0_20px_40px_-32px_rgba(15,23,42,0.25)]"}`}>
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className={`rounded-[1.2rem] border px-4 py-3 text-sm font-medium ${isDark ? "border-violet-400/20 bg-violet-500/10 text-violet-300" : "border-violet-300/40 bg-violet-50 text-violet-700"}`}>RBT concepts</div>
          <div className={`rounded-[1.2rem] border px-4 py-3 text-sm font-medium ${isDark ? "border-white/10 bg-white/5 text-slate-300" : "border-slate-200 bg-white text-slate-600"}`}>Quick explanations</div>
          <div className={`rounded-[1.2rem] border px-4 py-3 text-sm font-medium ${isDark ? "border-white/10 bg-white/5 text-slate-300" : "border-slate-200 bg-white text-slate-600"}`}>Study prompts</div>
        </div>
      </div>
    ),
  },
...
const offeringCards = [
  {
    ...
    Icon: Target,
    className: "border-[#2D6BFF]/16 bg-[#2D6BFF]/7 text-[#1E5EFF] dark:border-[#2D6BFF]/24 dark:bg-[#2D6BFF]/10 dark:text-[#8EB0FF]",
  },
  {
    eyebrow: "Available now",
    title: "Flashcards",
    ...
    Icon: Brain,
    className: "border-emerald-300/35 bg-emerald-50 text-emerald-700 dark:border-emerald-400/20 dark:bg-emerald-500/10 dark:text-emerald-300",
  },
  {
    eyebrow: "Premium",
    ...
    Icon: LayoutDashboard,
    className: "border-amber-300/40 bg-amber-50 text-amber-700 dark:border-amber-400/20 dark:bg-amber-500/10 dark:text-amber-300",
  },
  {
    eyebrow: "Coming soon",
...
const gradientBlue = {
  background: "linear-gradient(90deg, #60B4FF 0%, #4F8CFF 100%)",
...
export default function Landing() {
  ...
  const outgoingPanel = outgoingPreviewIndex !== null ? premiumPreviewPanels[outgoingPreviewIndex] : null;
  ...
  const rotatePreview = (nextIndex) => {
    setActivePreviewIndex((current) => {
      ...
      if (resolvedNext === current) return current;
  ...
  useEffect(() => {
    const intervalId = window.setInterval(() => { rotatePreview(); }, 6400);
    return () => window.clearInterval(intervalId);
  }, []);

  const renderDesktopWindowBar = (title, stateLabel) => (
    <div className={`flex items-center justify-between border-b px-5 py-3 ${isDark ? "border-white/8 bg-white/[0.025]" : "border-slate-200/80 bg-white/65"}`}>
      ...
      <div className="flex items-center gap-3">
        <p className={`text-[11px] font-semibold uppercase tracking-[0.24em] ${isDark ? "text-slate-400" : "text-slate-500"}`}>{title}</p>
        <span className={`rounded-full border px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] ${isDark ? "border-white/10 bg-white/[0.03] text-slate-400" : "border-slate-200 bg-white/85 text-slate-500"}`}>{stateLabel}</span>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-foreground dark:bg-background">
            ...
            {isAuthenticated ? (
              <>
                <Link to={createPageUrl("Store")} className="hidden sm:block">
                  <Button variant="ghost" className="rounded-xl">Store</Button>
                </Link>
      ...
      <section
        ...
        style={{ background: "linear-gradient(145deg, #060d20 0%, #0b1535 55%, #0f1c48 100%)" }}
      >
        {/* Background glow orbs */}
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div
            className="absolute -top-32 left-1/4 h-[560px] w-[560px] rounded-full opacity-25"
            style={{ background: "radial-gradient(circle, #1E5EFF, transparent 65%)" }}
          />
          <div
          ...
          />
          <div
            className="absolute top-1/3 right-0 h-[300px] w-[300px] rounded-full opacity-10"
            style={{ background: "radial-gradient(circle, #4F8CFF, transparent 65%)" }}
          />
        </div>

        <div className="relative mx-auto max-w-5xl px-5 pb-20 pt-16 text-center sm:px-8 sm:pb-28 sm:pt-24">

          {/* Social proof pill */}
          <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/[0.07] px-4 py-2.5 backdrop-blur-sm">
            <div className="flex -space-x-2.5">
              {SOCIAL_AVATARS.map(({ letter, bg }) => (
                <div
                  key={letter}
                  className="flex h-7 w-7 items-center justify-center rounded-full border-2 border-[#0b1535] text-[11px] font-black text-white"
            ...
            <span className="text-sm font-medium text-white/75">
              {isEs ? "+1,200 RBTs estudian con nosotros" : "+1,200 RBTs studying with us"}
            </span>
            <span className="text-xs text-amber-400 tracking-wide">★★★★★</span>
          </div>

          {/* Giant headline */}
          <h1
            className="mt-8 font-jakarta font-black leading-[0.88] tracking-tight text-white"
            style={{ fontSize: "clamp(56px, 11vw, 120px)" }}
          >
            {isEs ? (
              <>
                Aprueba el{" "}
                <span style={gradientBlue}>examen</span>{" "}
                <span style={gradientPurple}>RBT</span>{" "}
                con estructura,{" "}
                no con suerte.
              </>
            ) : (
              <>
                Pass the{" "}
                <span style={gradientBlue}>RBT</span>{" "}
                <span style={gradientPurple}>exam</span>{" "}
                with structure,{" "}
                not luck.
              </>
            )}
          ...
          <div
            className="mx-auto mt-6 h-[3px] w-36 rounded-full sm:w-52"
            style={{ background: "linear-gradient(90deg, #4F8CFF, #818CF8)" }}
          />

          {/* Subtext */}
          <p className="mx-auto mt-7 max-w-2xl text-lg leading-relaxed text-slate-300 sm:text-xl">
            {isEs
              ? `RBT Genius combina más de ${TOTAL_PRACTICE_QUESTIONS} preguntas de práctica, flashcards, exámenes simulados y un tutor con IA — todo diseñado para que llegues al examen listo y confiado.`
              : `RBT Genius combines ${TOTAL_PRACTICE_QUESTIONS}+ practice questions, flashcards, mock exams, and an AI tutor — all designed to get you to exam day ready and confident.`}
          </p>
          ...
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            {isAuthenticated ? (
              <Link to={createPageUrl("Dashboard")}>
                <Button className="h-12 w-full rounded-2xl bg-[#1E5EFF] px-8 text-base font-bold shadow-xl shadow-[#1E5EFF]/30 hover:bg-[#1E5EFF]/90 sm:w-auto">
                  {isEs ? "Ir al Dashboard" : "Continue to Dashboard"}
              ...
              <>
                ...
                <Link to="/login">
                  <Button
                    variant="outline"
                    className="h-12 w-full rounded-2xl border-white/20 bg-white/[0.07] px-8 text-base text-white hover:bg-white/[0.12] hover:text-white sm:w-auto"
                  >
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        {/* ── Preview cards (moved from hero grid) ── */}
        <section className="grid gap-8 lg:grid-cols-2 lg:items-start lg:gap-10">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#FFB800]/20 bg-[#FFB800]/10 px-4 py-2 text-sm font-medium text-[#C88700] dark:border-[#FFB800]/25 dark:bg-[#FFB800]/12 dark:text-[#FFD36B]">
              ...
              {isEs ? "Vista previa de estudio" : "Study Preview"}
            </div>
            <h2 className="mt-4 font-jakarta text-2xl font-black tracking-tight text-slate-900 dark:text-slate-50 sm:text-3xl">
              {isEs ? "Todo lo que necesitas en un solo lugar." : "Everything you need in one place."}
            </h2>
            <p className="mt-3 max-w-lg text-base leading-7 text-slate-500 dark:text-slate-400">
              {isEs
                ? `Práctica, tarjetas de memoria, exámenes simulados y seguimiento de progreso — construidos sobre el mismo banco de ${TOTAL_PRACTICE_QUESTIONS} preguntas reales.`
                : `Practice, flashcards, mock exams, and progress tracking — all built on the same ${TOTAL_PRACTICE_QUESTIONS}-question bank across ${OFFICIAL_CONCEPT_COUNT} concepts.`}
            </p>
          </div>

          {/* Mobile preview card */}
          <div className="relative px-0 sm:hidden">
            {(() => {
              const activePanel = premiumPreviewPanels[activePreviewIndex];
              return (
                <div className={`rounded-[2rem] border p-3 ${isDark ? "border-slate-800 bg-[linear-gradient(180deg,#0b1224,#0a1020)]" : "border-slate-200/80 bg-[linear-gradient(180deg,#ffffff,#f8fafc)] shadow-[0_30px_80px_-50px_rgba(15,23,42,0.18)]"}`}>
                  ...
                  <div className={`overflow-hidden rounded-[1.75rem] ${isDark ? "bg-[linear-gradient(180deg,#0f1930,#0b1427)] shadow-[0_30px_80px_-50px_rgba(15,23,42,0.9)]" : "bg-[linear-gradient(180deg,#ffffff,#f8fafc)] shadow-[0_24px_60px_-42px_rgba(15,23,42,0.16)]"}`}>
                    <div className={`rounded-[1.75rem] ${isDark ? "bg-[linear-gradient(180deg,rgba(18,31,58,0.94),rgba(10,18,35,0.9))] text-white backdrop-blur-xl" : "bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(248,250,252,0.94))] text-slate-900 backdrop-blur-xl"}`}
                      style={{ animation: "landing-preview-mobile-enter 560ms cubic-bezier(0.19, 1, 0.22, 1) both" }}>
                      <div className={`flex items-center justify-between border-b px-4 py-3 ${isDark ? "border-white/8" : "border-slate-200/80"}`}>
                        <div className="flex items-center gap-1.5">
                          <span className="h-2.5 w-2.5 rounded-full bg-[#FF5F57]" />
                          <span className="h-2.5 w-2.5 rounded-full bg-[#FEBC2E]" />
                          <span className="h-2.5 w-2.5 rounded-full bg-[#28C840]" />
                        </div>
                        <div className={`text-[11px] font-semibold uppercase tracking-[0.18em] ${isDark ? "text-slate-400" : "text-slate-500"}`}>RBT Genius</div>
                      </div>
                      <div className="flex min-h-[246px] flex-col p-4 pb-4">
                        <div className="flex items-start gap-3">
                          <div className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl ${activePanel.accentClassName}`}>
                            <activePanel.Icon className="h-4 w-4" />
                          </div>
                          <div className="min-w-0">
                            <p className={`text-sm font-semibold leading-tight ${isDark ? "text-white" : "text-slate-900"}`}>{activePanel.title}</p>
                            <p className={`text-xs leading-5 ${isDark ? "text-slate-300" : "text-slate-500"}`}>{activePanel.subtitle}</p>
                          </div>
                        </div>
          ...
          <div className="relative hidden h-[470px] sm:block">
            {premiumPreviewPanels.map(({ label, title, subtitle, accentClassName, Icon, renderContent }, index) => {
              if (index === outgoingPreviewIndex) return null;
              const order = (index - activePreviewIndex + premiumPreviewPanels.length) % premiumPreviewPanels.length;
              ...
              return (
                <button
                  ...
                  style={{ transitionTimingFunction: "cubic-bezier(0.19, 1, 0.22, 1)", transitionDuration: "3000ms" }}
                >
                  <div className="overflow-hidden rounded-[1.9rem] sm:rounded-[2.1rem]">
                    ...
                    <div
                      ...
                      style={{ animation: order % 2 === 0 ? `landing-preview-drift ${isFrontCard ? "8.5s" : "10.5s"} ease-in-out infinite` : `landing-preview-drift-alt ${isFrontCard ? "9.25s" : "11.25s"} ease-in-out infinite`, animationDelay: `${index * 0.45}s` }}
                    >
                      <div className="flex items-start gap-3 sm:gap-4">
                        <div className={`mt-0.5 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl sm:h-12 sm:w-12 ${accentClassName}`}>
                          <Icon className="h-4 w-4 sm:h-5 sm:w-5" />
                        </div>
                        <div className="min-w-0">
                          <p className={`text-[10px] font-semibold uppercase tracking-[0.22em] sm:text-[11px] sm:tracking-[0.24em] ${isDark ? "text-slate-500/90" : "text-slate-400"}`}>{label}</p>
                          <p className={`text-sm font-semibold leading-tight sm:text-base ${isDark ? "text-white" : "text-slate-900"}`}>{title}</p>
                          <p className={`max-w-md text-xs leading-5 sm:text-sm ${isDark ? "text-slate-300" : "text-slate-500"}`}>{subtitle}</p>
                        </div>
                      </div>
                      <div className="mt-4 flex-1">
                        {isFrontCard ? renderContent(isDark) : (
                          <div className="space-y-4">
            ...
            {outgoingPanel && (
              <div
                aria-hidden="true"
                className={`pointer-events-none absolute left-1/2 top-0 z-40 w-[96%] -translate-x-1/2 rounded-[1.9rem] border text-left sm:w-[92%] sm:rounded-[2.1rem] ${isDark ? "border-slate-300/12 bg-[linear-gradient(180deg,rgba(18,31,58,0.9),rgba(10,18,35,0.86))] text-white backdrop-blur-xl" : "border-slate-200/90 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.95))] text-slate-900 shadow-[0_28px_80px_-48px_rgba(15,23,42,0.20)] backdrop-blur-xl"}`}
                style={{ animation: "landing-preview-orbit-exit 3200ms cubic-bezier(0.19, 1, 0.22, 1) forwards" }}
              >
                <div className="overflow-hidden rounded-[1.9rem] sm:rounded-[2.1rem]">
                  ...
                  <div className="flex min-h-[290px] flex-col p-5 pb-5 sm:min-h-[390px] sm:p-6 sm:pb-7">
                    <div className="flex items-start gap-3 sm:gap-4">
                      <div className={`mt-0.5 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl sm:h-12 sm:w-12 ${outgoingPanel.accentClassName}`}>
                        <outgoingPanel.Icon className="h-4 w-4 sm:h-5 sm:w-5" />
                      </div>
                      <div className="min-w-0">
                        <p className={`text-[10px] font-semibold uppercase tracking-[0.22em] sm:text-[11px] sm:tracking-[0.24em] ${isDark ? "text-slate-500/90" : "text-slate-400"}`}>{outgoingPanel.label}</p>
                        <p className={`text-sm font-semibold leading-tight sm:text-base ${isDark ? "text-white" : "text-slate-900"}`}>{outgoingPanel.title}</p>
                        <p className={`max-w-md text-xs leading-5 sm:text-sm ${isDark ? "text-slate-300" : "text-slate-500"}`}>{outgoingPanel.subtitle}</p>
                      </div>
                    </div>
        ...
        {/* ── Feature cards ── */}
        <section className="mt-14 grid gap-4 md:mt-16 md:grid-cols-3 md:gap-5">
          {featureCards.map(({ title, description, Icon }) => (
            <div key={title} className="rounded-[1.75rem] border border-slate-200/80 bg-white p-6 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.22)] dark:border-slate-800 dark:bg-slate-950">
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
              <div>
                ...
                <ul className="mt-6 space-y-3">
                  {["1,100+ practice questions available offline", "85-question timed mock exams with pass/fail scoring", "Tap-to-flip flashcards with topic filters", "Haptic feedback and native iOS feel"].map((feature) => (
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  <a href="https://apps.apple.com/app/rbt-genius/id0000000000" target="_blank" rel="noopener noreferrer"
                  ...
                  <a href="https://play.google.com/store/apps/details?id=com.rbtgenius.app" target="_blank" rel="noopener noreferrer"
                    className={`inline-flex items-center gap-3 rounded-2xl border px-5 py-3 transition-opacity hover:opacity-80 ${isDark ? "border-slate-700 bg-slate-900" : "border-slate-200 bg-slate-50 shadow-sm"}`}>
              ...
              <div className="flex justify-center lg:justify-end">
                <div className={`relative w-[220px] rounded-[2.8rem] border-[6px] p-2 shadow-2xl sm:w-[260px] ${isDark ? "border-slate-700 bg-slate-900" : "border-slate-300 bg-white"}`}>
                  ...
                  <div className={`rounded-[2rem] p-4 ${isDark ? "bg-[#020617]" : "bg-[#EEF4FB]"}`} style={{ minHeight: 380 }}>
                    ...
                    {[{ label: "A", text: "Fixed Ratio", correct: false }, { label: "B", text: "Variable Ratio", correct: true }, { label: "C", text: "Fixed Interval", correct: false }].map((opt) => (
        ...
        <section className="mt-14 rounded-[2rem] border border-slate-200/80 bg-white p-5 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.22)] dark:border-slate-800 dark:bg-slate-950 sm:mt-16 sm:p-8">
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-5">
            {offeringCards.map(({ eyebrow, title, description, Icon, className }) => (
              <div key={title} className="rounded-[1.5rem] border border-slate-200/80 bg-slate-50/70 p-5 dark:border-slate-800 dark:bg-slate-900/60">
                <div className={`inline-flex h-11 w-11 items-center justify-center rounded-2xl border ${className}`}>
                  <Icon className="h-5 w-5" />
                </div>
                <p className="mt-4 text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-400 dark:text-slate-500">{eyebrow}</p>
        ...
        <section className="mt-14 rounded-[2rem] border border-slate-200/80 bg-white p-5 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.22)] dark:border-slate-800 dark:bg-slate-950 sm:mt-16 sm:p-8">
            ...
            <table className="min-w-full">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-800">
                  {["Feature", "Guest", "Free", "Premium"].map((h) => (
                    <th key={h} className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-[0.22em] text-slate-400">{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {ACCESS_COMPARISON.map((row) => (
                  <tr key={row.id} className="border-b border-slate-100 last:border-b-0 dark:border-slate-900">
                    <td className="px-4 py-4 text-sm font-semibold text-slate-900 dark:text-slate-100">{row.label}</td>
                    <td className="px-4 py-4 text-sm text-slate-500 dark:text-slate-400">{row.guest}</td>
                    <td className="px-4 py-4 text-sm text-slate-500 dark:text-slate-400">{row.free}</td>
                    <td className="px-4 py-4 text-sm text-slate-500 dark:text-slate-400">{row.premium}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-8 space-y-4 md:hidden">
            {[
              { title: "Guest", desc: "Explore the product, preview pricing, and see how the study flow works before signing up." },
              { title: "Free", desc: "Build a daily routine with guided practice and flashcards." },
              { title: "Premium", desc: "Unlock full mock exams, analytics, unlimited study support, and the complete prep experience." },
            ].map(({ title, desc }) => (
              <div key={title} className="rounded-[1.4rem] border border-slate-200 bg-slate-50/70 p-4 dark:border-slate-800 dark:bg-slate-900/50">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            {isAuthenticated ? (
              <Link to={createPageUrl("Dashboard")}>
                <Button className="w-full rounded-2xl bg-[#1E5EFF] px-6 hover:bg-[#1E5EFF]/90 sm:w-auto">Go to Dashboard</Button>
              </Link>
            ) : (
              <Link to="/login?mode=register">
                <Button className="w-full rounded-2xl bg-[#1E5EFF] px-6 hover:bg-[#1E5EFF]/90 sm:w-auto">Start Free</Button>
              </Link>
            )}
            <Link to={createPageUrl("Pricing")}>
              <Button variant="outline" className="w-full rounded-2xl px-6 sm:w-auto">View Full Pricing</Button>
            </Link>
            <Link to={createPageUrl("Store")}>
              <Button variant="outline" className="w-full rounded-2xl px-6 sm:w-auto">Visit Store</Button>
            </Link>
          </div>
        </section>
